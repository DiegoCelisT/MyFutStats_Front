...
@Component({
  selector: 'app-liga5',
  templateUrl: './liga5.component.html',
  styleUrls: ['./liga5.component.css']
})
export class Liga5Component implements OnInit {
  ...
  editLiga() {
    location.href="http://localhost:4200/liga5/editliga5"
  }
