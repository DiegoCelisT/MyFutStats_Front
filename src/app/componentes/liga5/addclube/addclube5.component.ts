...
@Component({
  selector: 'app-addclube5',
  templateUrl: './addclube5.component.html',
  styleUrls: ['./addclube5.component.css']
})

export class Addclube5Component implements OnInit {
  ...
  voltarLiga() {
    location.href ="http://localhost:"+this.FutebolServ.portFront+"/liga5?sucessoadd=ok"
  }
