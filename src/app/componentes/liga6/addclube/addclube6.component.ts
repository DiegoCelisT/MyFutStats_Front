...
@Component({
  selector: 'app-addclube6',
  templateUrl: './addclube6.component.html',
  styleUrls: ['./addclube6.component.css']
})

export class Addclube6Component implements OnInit {
  ...
  voltarLiga() {
    location.href ="http://localhost:"+this.FutebolServ.portFront+"/liga6?sucessoadd=ok"
  }
