...
@Component({
  selector: 'app-clube6',
  templateUrl: './clube6.component.html',
  styleUrls: ['./clube6.component.css']
})

export class Clube6Component implements OnInit {
  ...
  eliminarClube(){
    ...
    location.href='http://localhost:'+this.FutebolServ.portFront+'/liga6/'+'?sucessoeliminado=ok'
  }

  //CERRAR MODAL E IR PARA LIGA
  fechaModalEliminar() {
    location.href ="http://localhost:"+this.FutebolServ.portFront+"/liga6"
  }
