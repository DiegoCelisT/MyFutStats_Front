...
@Component({
  selector: 'app-editliga6',
  templateUrl: './editliga6.component.html',
  styleUrls: ['./editliga6.component.css']
})
export class Editliga6Component implements OnInit {
  ...
  editLiga(){
    this.FutebolServ.editLiga(6, this.name)
    .subscribe() 
    window.location.href="http://localhost:4200/liga6/editliga6"
  }
  ...
  addClube() {
    location.href="http://localhost:"+this.FutebolServ.portFront+"/liga6/addclube6/"
  }
