...
@Component({
  selector: 'app-clube2',
  templateUrl: './clube2.component.html',
  styleUrls: ['./clube2.component.css']
})

export class Clube2Component implements OnInit {
  ...
  eliminarClube(){
    ...
    location.href='http://localhost:'+this.FutebolServ.portFront+'/liga2/'+'?sucessoeliminado=ok'
  }

  //CERRAR MODAL E IR PARA LIGA
  fechaModalEliminar() {
    location.href ="http://localhost:"+this.FutebolServ.portFront+"/liga2"
  }

  //ROTA EDITAR CLUBE
  irEditClube() {
    location.href ="http://localhost:"+this.FutebolServ.portFront+"/liga2/editclube2/"+this.ID
  }
