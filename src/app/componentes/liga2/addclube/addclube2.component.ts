...
@Component({
  selector: 'app-addclube2',
  templateUrl: './addclube2.component.html',
  styleUrls: ['./addclube2.component.css']
})

export class Addclube2Component implements OnInit {
  ...
  voltarLiga() {
    location.href ="http://localhost:"+this.FutebolServ.portFront+"/liga2?sucessoadd=ok"
  }
