...
@Component({
  selector: 'app-clube4',
  templateUrl: './clube4.component.html',
  styleUrls: ['./clube4.component.css']
})

export class Clube4Component implements OnInit {
  ...
  eliminarClube(){
    ...
    location.href='http://localhost:'+this.FutebolServ.portFront+'/liga4/'+'?sucessoeliminado=ok'
  }

  //CERRAR MODAL E IR PARA LIGA
  fechaModalEliminar() {
    location.href ="http://localhost:"+this.FutebolServ.portFront+"/liga4"
  }

  //ROTA EDITAR CLUBE
  irEditClube() {
    location.href ="http://localhost:"+this.FutebolServ.portFront+"/liga4/editclube4/"+this.ID
  }
