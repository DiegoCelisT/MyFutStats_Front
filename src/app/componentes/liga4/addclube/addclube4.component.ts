...
@Component({
  selector: 'app-addclube4',
  templateUrl: './addclube4.component.html',
  styleUrls: ['./addclube4.component.css']
})

export class Addclube4Component implements OnInit {
  ...
  voltarLiga() {
    location.href ="http://localhost:"+this.FutebolServ.portFront+"/liga4?sucessoadd=ok"
  }
